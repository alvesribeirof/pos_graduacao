export class View {
    ...
    initializeParameters(params) {
        ...
        this.elements.topK.max = p.maxTopK;
        this.elements.topK.min = 1;
        this.elements.topK.value = p.defaultTopK;
        this.elements.topKValue.textContent = p.defaultTopK;

        this.elements.temperatureValue.textContent = p.defaultTemperature;
        this.elements.temperature.max = p.maxTemperature;
        this.elements.temperature.min = 0;
        this.elements.temperature.value = p.defaultTemperature;
    }
    ...
    handleFilePreview(event) {
        ...
        if (fileType === 'image') {
            ...
            pdfIcon.innerHTML = '📄 <strong>Arquivo PDF Selecionado</strong>';
            pdfIcon.className = 'preview-pdf';
            pdfIcon.style.padding = '10px';
            pdfIcon.style.color = '#0ea5e9';
